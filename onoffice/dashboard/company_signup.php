...
<div class="login">
<h1>SignUp</h1>
   <form id="company_form" action="../../controllers/company_database/onoffice_company_client_add.php" method="POST" class="panel-body wrapper-lg" enctype="multipart/form-data">
    <input type="text" name="company" placeholder="Company Name" class="form-control" required>
      ...
      <input type="text" name="language"  class="form-control" placeholder="Language" required>
       ...
       <div class="row">
       <div class="column3">
       <label class="col-sm-3 control-label" style="color:white;">Profile Picture</label> 
       </div>
       <div class="column4">
