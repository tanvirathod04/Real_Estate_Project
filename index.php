	...
	<head>
		...
		<link href="https://fonts.googleapis.com/css?family=Poppins:100,200,400,300,500,600,700" rel="stylesheet"> 
			...
			CSS
			============================================= -->
			<link rel="stylesheet" href="scss/css/linearicons.css">
			<link rel="stylesheet" href="scss/css/font-awesome.min.css">
			<link rel="stylesheet" href="scss/css/bootstrap.css">
			<link rel="stylesheet" href="scss/css/magnific-popup.css">
			<link rel="stylesheet" href="scss/css/nice-select.css">					
			<link rel="stylesheet" href="scss/css/animate.min.css">
			  ...
			  <header id="header" id="home">
			    <div class="container">
			    	<div class="row align-items-center justify-content-between d-flex">
				      <div id="logo">
				        <a href="index.php"><!--<img src="img/logo.png" alt="" title="" />-->
						<h3 style="color:#fff;">RealEstate</h3>
						</a>
				      </div>
				      <nav id="nav-menu-container">
				        <ul class="nav-menu">
				          ...
				          <li><a class="ticker-btn" href="signin.php">Get Started</a></li>				          
				        </ul>
				...
				<div class="container-fluid">
					<div class="row justify-content-end align-items-center">
						<div class="col-lg-4 no-padding video-right">
							...
							Video of Realestate to start</h1>
							...
							<div class="single-price no-padding">
								...
								<div class="price-bottom">
									<div class="price-wrap d-flex flex-row justify-content-center">
										<span class="price">$</span><h1> 0 </h1><span class="time">Per <br> Month</span>
									</div>
									<a href="onoffice/dashboard/company_signup.php?package=basic" class="primary-btn header-btn">Get Started</a>
								</div>
						...
						<div class="col-lg-4">
							<div class="single-price no-padding">
								...
								<div class="price-bottom">
									...
									<a href="teamproq/dashboard/company_signup.php?package=standard" class="primary-btn header-btn">Get Started</a>
								</div>
							</div>
						</div>
						<div class="col-lg-4">
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
			...
			<script src="scss/js/vendor/jquery-2.2.4.min.js"></script>
			<script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.12.9/umd/popper.min.js" integrity="sha384-ApNbgh9B+Y1QKtv3Rn7W3mgPxhU9K/ScQsAP7hUibX39j7fakFPskvXusvfa0b4Q" crossorigin="anonymous"></script>
			<script src="scss/js/vendor/bootstrap.min.js"></script>			
			<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBhOdIF3Y9382fqJYt5I_sswSrEw5eihAA"></script>
  			<script src="scss/js/easing.min.js"></script>			
			<script src="scss/js/hoverIntent.js"></script>
			<script src="scss/js/superfish.min.js"></script>	
			<script src="scss/js/jquery.ajaxchimp.min.js"></script>
			<script src="scss/js/jquery.magnific-popup.min.js"></script>	
			<script src="scss/js/owl.carousel.min.js"></script>			
			<script src="scss/js/jquery.sticky.js"></script>
			<script src="scss/js/jquery.nice-select.min.js"></script>			
			<script src="scss/js/parallax.min.js"></script>		
			<script src="scss/js/mail-script.js"></script>	
