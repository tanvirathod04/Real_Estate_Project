...
if($_SERVER['REQUEST_METHOD']=='POST'){
    ...
    $marketing_method= $_POST['marketing_method'];;
        ...
        $property_basic_data_id1=$propertyClass->propertyBasicDataUpdate($property_basic_data_id,$session_uid, $Data_Record_Ref_No,
    ...
    if($property_basic_data_id1)
    {
       ...
       echo "<script>alert('Property Basic Edited  successfully');</script>";
