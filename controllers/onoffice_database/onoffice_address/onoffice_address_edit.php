...
if($_SERVER['REQUEST_METHOD']=='POST'){
    $address_basic_data_id = $_POST['id'];
        ...
        //$Customer_logo =  $_POST['Customer_logo'];
        ...
        $address_basic_data_id1=$addressClass->addressBasicDataUpdate($address_basic_data_id,$session_uid, $salutation, $entry_date, $first_name,
    ...
    if($address_basic_data_id1)
    {
       ...
       echo "<script>alert('Address Basic Edited  successfully');</script>";
