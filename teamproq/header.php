...
include('../../session.php');
$userDetails=$teamproquserClass->userDetails($teamproqsession_uid);
//print_r($userDetails);
?>
<!DOCTYPE html>
                    ...
                    <li  class="active" >
                      <a href="../dashboard/dashboard.php"  onMouseOver="this.style.color='black'" onMouseOut="this.style.color='#ffffff'">
                        ...
                        <?php
                           ...
                           ?>  
                           <li class="active">
                        <a href="../office365/" onMouseOver="this.style.color='black'" onMouseOut="this.style.color='#ffffff'" >   
                           <i class="fa fa-calendar">
                           <b class="bg-primary dker"></b></i>
                            <span>Office365</span>
                          </a>
                           ...
                           <li class="active">
                        <a href="../file_management/" onMouseOver="this.style.color='black'" onMouseOut="this.style.color='#ffffff'" >   
                           <i class="fa fa-calendar">
                           <b class="bg-primary dker"></b></i>
  ...
  <section class="vbox">
    <header class="bg-dark dk header navbar navbar-fixed-top-xs">
      <div class="navbar-header aside-md">
        ...
        <h3 style="color:#fff;">TeamProQ </h3>
