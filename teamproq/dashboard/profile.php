        ...
        <section id="content">
          <section class="vbox">
           ...
           <form action="../../controllers/onoffice_database/onoffice_client/onoffice_client_edit.php" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="inline">
                          <div id="imgFileUpload" class="easypiechart" data-percent="75" data-line-width="5" data-bar-color="#4cc0c1" data-track-Color="#f5f5f5" data-scale-Color="false" data-size="130" data-line-cap='butt' data-animate="1000">
                            <div class="thumb-lg">
